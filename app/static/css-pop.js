...
function book_plot(start_run, end_run, name ) { 
           name = typeof name !== 'undefined' ? name : "Just histogram";
           start_run = typeof start_run !== 'undefined' ? start_run : 0;
           end_run = typeof end_run !== 'undefined' ? end_run : 10;
           var xVals = [];
           var yVals = [];
           for (var i=start_run; i<end_run; i++){
